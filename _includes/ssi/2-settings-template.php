...
<ol>
<li>Additional company logos can be added by placing them in the folder "<code>_includes/brands</code>" and then selected from this page.</li>
<li>Additional client logos can be added by placing them in the folder "<code>_includes/clients</code>" and then selected from this page.</li>
<li>Any new header logos will need to be transparent PNGs that are formatted in the same way as the files that come with this platform.</li>
...
if(isset($_GET['brand'])){
	...
	// Writing variable to arrays to get ready to wite siteconfig.php
	$old_entries = array(
		'brand = "'.$brand.'"',
...
<td class="rcol">
<input type="text" maxlength="40" name="brand" value="<?php echo $brand; ?>" onblur="if(this.value==''){this.value='<?php echo $brand; ?>';}"
 onfocus="if(this.value=='<?php echo $brand; ?>'){this.value='';}">
</td></tr>

<tr><td class="lcol">Company Address:</td>
<td class="rcol">
<input type="text" maxlength="40" name="office_loc" value="<?php echo $office_loc; ?>" onblur="if(this.value==''){this.value='<?php echo $office_loc; ?>';}"
 onfocus="if(this.value=='<?php echo $office_loc; ?>'){this.value='';}">
</td></tr>

<tr><td class="lcol"></td>
<td class="rcol">
<input type="text" maxlength="40" name="add1_loc" value="<?php echo $add1_loc; ?>" onblur="if(this.value==''){this.value='<?php echo $add1_loc; ?>';}"
 onfocus="if(this.value=='<?php echo $add1_loc; ?>'){this.value='';}">
</td></tr>

<tr><td class="lcol"></td>
<td class="rcol">
<input type="text" maxlength="40" name="add2_loc" value="<?php echo $add2_loc; ?>" onblur="if(this.value==''){this.value='<?php echo $add2_loc; ?>';}"
 onfocus="if(this.value=='<?php echo $add2_loc; ?>'){this.value='';}">
</td></tr>

<tr><td class="lcol"></td>
<td class="rcol">
<input type="text" maxlength="40" name="add3_loc" value="<?php echo $add3_loc; ?>" onblur="if(this.value==''){this.value='<?php echo $add3_loc; ?>';}"
 onfocus="if(this.value=='<?php echo $add3_loc; ?>'){this.value='';}">
</td></tr>

<tr><td class="lcol">Account Director Name:</td>
<td class="rcol">
<input type="text" maxlength="40" name="cont_name" value="<?php echo $cont_name; ?>" onblur="if(this.value==''){this.value='<?php echo $cont_name; ?>';}"
 onfocus="if(this.value=='<?php echo $cont_name; ?>'){this.value='';}">
</td></tr>

<tr><td class="lcol">Title:</td>
<td class="rcol">
<input type="text" maxlength="40" name="cont_title" value="<?php echo $cont_title; ?>" onblur="if(this.value==''){this.value='<?php echo $cont_title; ?>';}"
 onfocus="if(this.value=='<?php echo $cont_title; ?>'){this.value='';}">
</td></tr>

<tr><td class="lcol">Phone:</td>
<td class="rcol">
<input type="text" maxlength="40" name="cont_phone" value="<?php echo $cont_phone; ?>" onblur="if(this.value==''){this.value='<?php echo $cont_phone; ?>';}"
 onfocus="if(this.value=='<?php echo $cont_phone; ?>'){this.value='';}">
</td></tr>

<tr><td class="lcol">Email:</td>
<td class="rcol">
<input type="text" maxlength="40" name="cont_email" value="<?php echo $cont_email; ?>" onblur="if(this.value==''){this.value='<?php echo $cont_email; ?>';}"
 onfocus="if(this.value=='<?php echo $cont_email; ?>'){this.value='';}">
</td></tr>
...
function mkmap_brands($dir_accord){
    ...
    foreach($ffs_accord as $file_accord){
        if($file_accord != '.' && $file_accord!= '..' ){
            ...
            // Displays available Publicis company logos as form entries.
...
<td class="rcol">
<input type="text" maxlength="40" name="page_title" value="<?php echo $page_title; ?>" onblur="if(this.value==''){this.value='<?php echo $page_title; ?>';}"
 onfocus="if(this.value=='<?php echo $page_title; ?>'){this.value='';}">
</td></tr>
