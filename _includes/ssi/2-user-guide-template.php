...
<p>For additional information on the kind of content that can be placed in the external content section, view the 
<a href="https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet" target="_blank">Makrdown Cheatsheet</a> for a complete guide on 
what kind of syntax can be used in this area.  </p>
