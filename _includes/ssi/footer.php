<footer>
<p>&copy; <script>new Date().getFullYear()</script> <a href="http://www.razorfish.com/" target="_blank">Razorfish, LLC</a>  &nbsp|&nbsp  
<!--<a href="/">Privacy Policy</a>  &nbsp|&nbsp   
<a href="/">Site Map</a>  &nbsp|&nbsp  -->
<a href="/">Usage Guide</a><?php if($_SESSION['username']): ?>&nbsp;&nbsp;&nbsp;<a href="/login.php?logout=1">Logout</a><?php endif; ?></p>
