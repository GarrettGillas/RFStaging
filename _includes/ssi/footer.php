<footer>
<<<<<<< HEAD
<p>&copy; <?php echo date("Y"); ?> Razorfish, LLC  &nbsp|&nbsp  
...
<a href="/login.php?logout=1">Logout</a><?php endif; ?></p>
<p id="copy">Razorfish Client Preview <a href="https://razorfish-nw.atlassian.net/browse/EXTRANET-2" target="_blank">Version 1.1</a></p>
=======
<p>&copy; <script>new Date().getFullYear()</script> Razorfish, LLC  &nbsp|&nbsp  
<a href="mailto:garrett.gillas@razorfish.com?subject=Razorfish Client Preview Support Question">Support</a>  &nbsp|&nbsp   
<!--<a href="/">Site Map</a>  &nbsp|&nbsp  -->
<a href="<?php echo "http://".$_SERVER['HTTP_HOST']."/user-guide/";?>">User Guide</a><?php if($_SESSION['username']): ?>&nbsp;|&nbsp;<a href="/login.php?logout=1">Logout</a><?php endif; ?></p>
