...
<a href="/login/?logout=1"><?php if($_SESSION['is_admin'] == true) {echo "(Admin) ";}?>Logout</a>
<?php endif; ?></p>
<p id="copy">Razorfish Client Preview <a href="https://razorfish-nw.atlassian.net/browse/EXTRANET-2" target="_blank">Version 1.6</a></p>
